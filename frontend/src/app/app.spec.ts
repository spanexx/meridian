 ...
 *
 * The router is shell-aware: /login and /register are shell-less (no
 * ui-shell), every other route renders inside ui-shell.
 *
 * @owner   spanexx
 * @reviewed 2026-08-11
 */
...
/** Minimal routable content so router.navigateByUrl() to /login|/dashboard works. */
...
describe('App', () => {
  ...
  it('renders ui-shell on a normal (non-auth) route', async () => {
