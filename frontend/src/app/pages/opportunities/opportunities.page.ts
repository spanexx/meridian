...
export class OpportunitiesPageComponent {
  ...
  readonly all: Opportunity[] = [
    { ref: 'O-2051', title: 'Bulk Lego Set Resale',           subtitle: 'Retired Star Wars sets · 6 lots',                 category: 'collectibles', submitter: { initials: 'SP', name: 'Sarah Park',     gradient: 'var(--gradient-copper)' }, estRoi: 34.2, capital: 8200,  votesUp: 4,  votesDown: 0, status: 'vetting' },
    ...
    { ref: 'O-2048', title: 'Designer Furniture Resale',      subtitle: 'Herman Miller · 12 chairs from office clearance', category: 'furniture',    submitter: { initials: 'JT', name: 'Jules Tan',      gradient: 'var(--gradient-copper)' }, estRoi: 18.5, capital: 7800,  votesUp: null, votesDown: null, status: 'pending' },
    ...
    { ref: 'O-2045', title: 'Vinyl Record Collection',        subtitle: 'First pressings · 320 records',                  category: 'collectibles', submitter: { initials: 'AC', name: 'Alex Chen',      gradient: 'var(--gradient-copper)' }, estRoi: 28.6, capital: 3200,  votesUp: 5,  votesDown: 0, status: 'approved' },
    { ref: 'O-2043', title: 'PS5 Bundle Bulk',                subtitle: '8 bundles · wholesale',                          category: 'electronics',  submitter: { initials: 'SP', name: 'Sarah Park',     gradient: 'var(--gradient-copper)' }, estRoi: 15.2, capital: 22000, votesUp: 4,  votesDown: 1, status: 'approved' },
    ...
    { ref: 'O-2031', title: 'Eames Lounge Replica (no-auth)', subtitle: 'Forged lounge · no certificate',                category: 'furniture',    submitter: { initials: 'KT', name: 'Kenji Tanaka',   gradient: 'var(--gradient-copper)' }, estRoi: 6.0,  capital: 1400,  votesUp: 1,  votesDown: 6, status: 'rejected' },
    ...
    { ref: 'O-2025', title: 'Gibson Les Paul Studio',         subtitle: '2018 sunburst · hard case included',             category: 'electronics',  submitter: { initials: 'DO', name: 'Daria Olsen',    gradient: 'var(--gradient-copper)' }, estRoi: 11.0, capital: 2200,  votesUp: 3,  votesDown: 3, status: 'vetting' },
    ...
    { ref: 'O-2019', title: 'Stone Island Shadow Project',    subtitle: 'Jacket · FW23',                                  category: 'apparel',      submitter: { initials: 'IK', name: 'Ivan Kovalev',   gradient: 'var(--gradient-copper)' }, estRoi: 19.0, capital: 1100,  votesUp: 4,  votesDown: 4, status: 'approved' },
    { ref: 'O-2014', title: 'Yeezy Boost 350 V2 (Bone)',      subtitle: 'Deadstock · size 10',                            category: 'apparel',      submitter: { initials: 'SP', name: 'Sarah Park',     gradient: 'var(--gradient-copper)' }, estRoi: 22.0, capital: 7600,  votesUp: 5,  votesDown: 5, status: 'rejected' },
    ...
    { ref: 'O-2008', title: 'Wüsthof Classic 8" chef knife', subtitle: '3-piece set',                                    category: 'equipment',    submitter: { initials: 'RM', name: 'Rolf Müller',    gradient: 'var(--gradient-copper)' }, estRoi: 12.0, capital: 240,   votesUp: 4,  votesDown: 4, status: 'pending' },
    ...
    { ref: 'O-2002', title: 'Nike Air Max 1 × 5 lots',        subtitle: 'OG colorways · deadstock',                       category: 'apparel',      submitter: { initials: 'JA', name: 'Jay Adekunle',   gradient: 'var(--gradient-copper)' }, estRoi: 18.0, capital: 4200,  votesUp: 3,  votesDown: 4, status: 'pending' },
    ...
    { ref: 'O-1984', title: 'Roland TR-08 Rhythm Composer',   subtitle: 'Boutique · original box',                         category: 'electronics',  submitter: { initials: 'DO', name: 'Daria Olsen',    gradient: 'var(--gradient-copper)' }, estRoi: 7.0,  capital: 480,   votesUp: 3,  votesDown: 2, status: 'pending' },
    ...
    { ref: 'O-1970', title: "Kaws 'OriginalFake' Companion",  subtitle: '2002 · opened display',                          category: 'collectibles', submitter: { initials: 'IK', name: 'Ivan Kovalev',   gradient: 'var(--gradient-copper)' }, estRoi: 13.0, capital: 1800,  votesUp: 5,  votesDown: 4, status: 'rejected' },
    { ref: 'O-1963', title: 'Professional Espresso Machine',  subtitle: 'La Marzocco Linea Mini',                         category: 'equipment',    submitter: { initials: 'RM', name: 'Rolf Müller',    gradient: 'var(--gradient-copper)' }, estRoi: 25.0, capital: 6800,  votesUp: 6,  votesDown: 1, status: 'approved' },
  ];
