...
const ICON_PATHS: Readonly<Record<string, string>> = Object.freeze({
  ...
  'archive': '<rect x="2" y="3" width="20" height="5" rx="1"></rect><path d="M4 8v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8"></path><line x1="10" y1="12" x2="14" y2="12"></line>',
  'armchair': '<path d="M19 9V6a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v3" ></path> <path d="M3 11v5a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-5a2 2 0 0 0-4 0v2H7v-2a2 2 0 0 0-4 0Z" ></path> <path d="M5 18v2" ></path> <path d="M19 18v2" ></path>',
  ...
  'bell-off': '<path d="M8.7 3A6 6 0 0 1 18 8a21.3 21.3 0 0 0 .6 5" ></path> <path d="M17 17H3s3-2 3-9a4.67 4.67 0 0 1 .3-1.7" ></path> <path d="M10.3 21a1.94 1.94 0 0 0 3.4 0" ></path> <path d="m2 2 20 20" ></path>',
  'bookmark': '<path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z"></path>',
  'bot': '<rect width="18" height="10" x="3" y="11" rx="2" ></rect> <circle cx="12" cy="5" r="2" ></circle> <path d="M12 7v4" ></path> <line x1="8" x2="8" y1="16" y2="16" ></line> <line x1="16" x2="16" y1="16" y2="16" ></line>',
  ...
  'key-round': '<path d="M2 18v3c0 .6.4 1 1 1h4v-3h3v-3h2l1.4-1.4a6.5 6.5 0 1 0-4-4Z" ></path> <circle cx="16.5" cy="7.5" r=".5" ></circle>',
  ...
  'warehouse': '<path d="M22 8.35V20a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8.35A2 2 0 0 1 2.94 6.55l9-5.19a2 2 0 0 1 2.12 0l9 5.19A2 2 0 0 1 22 8.35Z"></path><path d="M6 18h12"></path><path d="M6 14h12"></path>',
